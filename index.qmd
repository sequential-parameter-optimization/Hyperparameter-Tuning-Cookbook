...
@sec-hpt-random-forest-classifier describes the hyperparameter tuning of a random forest classifier from `scikit-learn` [https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.RandomForestClassifier.html] with `spotPython`.
@sec-hpt-sklearn-xgb-classifier-vbdp-data describes the hyperparameter tuning of a XGBoost classifier from `scikit-learn` [https://scikit-learn.org/stable/modules/ensemble.html#histogram-based-gradient-boosting] with `spotPython`.
@sec-hpt-sklearn-svc-vbdp-data describes the hyperparameter tuning of a support vector classifier from `scikit-learn` [https://scikit-learn.org/stable/modules/generated/sklearn.svm.SVC.html#sklearn.svm.SVC] with `spotPython`.
@sec-hpt-sklearn-knn-classifier-vbdp-data describes the hyperparameter tuning of a k-nearest neighbors classifier from `scikit-learn` [https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.KNeighborsClassifier.html] with `spotPython`.
