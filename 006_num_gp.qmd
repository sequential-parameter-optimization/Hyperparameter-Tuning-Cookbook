...
```{python}
#| label: fig-bi9040
#| fig-cap: "Bivariate Normal. Mean zero and covariance $\\Sigma=\\begin{pmatrix} 9 & 0 \\\\ 0 & 4\\end{pmatrix}$"
import numpy as np
rng = np.random.default_rng()
import matplotlib.pyplot as plt
mean = [0, 0]
...
#| echo: false
#| label: fig-bi0000
#| fig-cap: "Bivariate Normal. Mean zero and covariance $\\Sigma=\\begin{pmatrix} 0 & 0 \\\\ 0 & 0\\end{pmatrix}$"
import numpy as np
rng = np.random.default_rng()
import matplotlib.pyplot as plt
mean = [0, 0]
cov = [[0, 0], [0, 0]]  # diagonal covariance
x, y = rng.multivariate_normal(mean, cov, 1000).T
plt.plot(x, y, 'x')
plt.axis('equal')
plt.grid()
...
#| echo: false
#| label: fig-bi0900
#| fig-cap: "Bivariate Normal. Mean zero and covariance $\\Sigma=\\begin{pmatrix} 0 & 9 \\\\ 0 & 0\\end{pmatrix}$"
import numpy as np
rng = np.random.default_rng()
import matplotlib.pyplot as plt
mean = [0, 0]
cov = [[0, 9], [0, 0]]  # diagonal covariance
x, y = rng.multivariate_normal(mean, cov, 1000).T
plt.plot(x, y, 'x')
plt.axis('equal')
plt.grid()
...
#| echo: false
#| label: fig-bi9000
#| fig-cap: "Bivariate Normal. Mean zero and covariance $\\Sigma=\\begin{pmatrix} 9 & 0 \\\\ 0 & 0\\end{pmatrix}$"
import numpy as np
rng = np.random.default_rng()
import matplotlib.pyplot as plt
mean = [0, 0]
cov = [[9, 0], [0, 0]]  # diagonal covariance
x, y = rng.multivariate_normal(mean, cov, 1000).T
plt.plot(x, y, 'x')
plt.axis('equal')
plt.grid()
...
#| echo: false
#| label: fig-bi0040
#| fig-cap: "Bivariate Normal. Mean zero and covariance $\\Sigma=\\begin{pmatrix} 0 & 0 \\\\ 4 & 0\\end{pmatrix}$"
import numpy as np
rng = np.random.default_rng()
import matplotlib.pyplot as plt
mean = [0, 0]
cov = [[0, 0], [4, 0]]  # diagonal covariance
x, y = rng.multivariate_normal(mean, cov, 1000).T
plt.plot(x, y, 'x')
plt.axis('equal')
plt.grid()
...
#| echo: false
#| label: fig-bi0004
#| fig-cap: "Bivariate Normal. Mean zero and covariance $\\Sigma=\\begin{pmatrix} 0 & 0 \\\\ 0 & 4\\end{pmatrix}$"
import numpy as np
rng = np.random.default_rng()
import matplotlib.pyplot as plt
mean = [0, 0]
cov = [[0, 0], [0, 4]]  # diagonal covariance
x, y = rng.multivariate_normal(mean, cov, 1000).T
plt.plot(x, y, 'x')
plt.axis('equal')
plt.grid()
...
#| echo: false
#| label: fig-bi9494
#| fig-cap: "Bivariate Normal. Mean zero and covariance $\\Sigma=\\begin{pmatrix} 9 & 4 \\\\ 9 & 4\\end{pmatrix}$"
import numpy as np
rng = np.random.default_rng()
import matplotlib.pyplot as plt
mean = [0, 0]
cov = [[9, 4], [9, 4]]  # diagonal covariance
x, y = rng.multivariate_normal(mean, cov, 1000).T
plt.plot(x, y, 'x')
plt.axis('equal')
plt.grid()
...
```{python}
Y = multivariate_normal(zeros(Psi.shape[0]), Psi, size = 3).reshape(-1,3)
plt.plot(X, Y)
plt.title("Realization of Random Functions under a GP prior.\n theta: {}".format(theta[0]))
plt.show()
```
