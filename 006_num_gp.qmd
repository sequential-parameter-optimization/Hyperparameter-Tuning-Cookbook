...
$$
The random process has a mean of $\vec{\mu}$ (which is a $(n \times 1)$-dimensional vector).
The $n$ $k$-dimensional random variables are correlated with each other using the basis function expression
$$
