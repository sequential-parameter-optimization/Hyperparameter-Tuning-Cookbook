...
Covariance decays exponentially fast as $x$ and $x'$ become farther apart. Observe that 
$$\Sigma(x,x) = 1$$ and 
$$\Sigma(x, x') < 1$$ for  $x \neq x'$ 
