...
* Integration with TensorBoard: Visualization of the hyperparameter tuning process, of the traing steps, the model graph. Parallel coordinates plot, scatter plot matrix, and more.
