...
```{python}
from spotpython.utils import fun_control_init, design_control_init, surrogate_control_init, optimizer_control_init
spot_1 = Spot(fun=fun,
...
```{python}
from spotpython.utils import fun_control_init, design_control_init, optimizer_control_init, surrogate_control_init
