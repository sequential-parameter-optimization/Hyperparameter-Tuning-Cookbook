...
@sec-bfgs presents an optimization algorithm that uses gradient information to find the minimum.


### Broyden-Fletcher-Goldfarb-Shanno Algorithm (BFGS) {#sec-bfgs}
